...
public class TransformationData extends Data {
	...
	public void updateTransformationMatrix() {
		...
		this.transformation.m00(1.0F);
		this.transformation.m11(1.0F);
		this.transformation.m22(1.0F);
		this.transformation.m33(1.0F);
		this.transformation.translate(this.position);
		this.transformation.rotateX((float) Math.toRadians(this.rotation.x));
		this.transformation.rotateY((float) Math.toRadians(this.rotation.y));
		this.transformation.rotateZ((float) Math.toRadians(this.rotation.z));
